	...
	public Options() {
		...
		contentPane.setLayout(new MigLayout("",
				"[100px:100px:300px][100px:100px:300px,fill][300px:300px:500px,grow][1px:1px:300px,grow][100px:100px:300px,fill][10px:10px:300px,fill]" +
						"[100px:100px:300px,fill][][][][][10px:10px:30px,grow][10px:10px:300px,grow][][1px:100px:300px,grow][1px:1px:300px,grow]",
...
//		themeLabel.setHorizontalAlignment(SwingConstants.CENTER);
		...
		for (Component component : components) {
			if (component instanceof JCheckBox ) {
				...
				try {
					checkbox.setSelectedIcon(new ImageIcon(ImageIO.read(new File("check1.png"))));
				}
				catch (Exception e)
				{
