...
public class OptionsProper extends JPanel {
...
//
     ...
     */
    public OptionsProper(JFrame parentFrame) {
        ...
        String[] RezBox  = {"2500x1440","1900x1440","1900x1200","1920x1080","1440x1200","1200x1000","1200x800","1200x600"};
...
//        }
        ...
        if ((int) op[0] != -1 ) {
            ...
            theme_ = (String) op[9];
            ThemeWindow(theme_,parentFrame);


            // fixed window
            System.out.println("---> " + op[10] );
            FixedCheckBox.setSelected((int) op[10] == 1);
            FixedWindow((int) op[10],parentFrame);
        ...
        comboBox1.addItemListener(new ItemListener(){
            public void itemStateChanged(ItemEvent e){
                ...
                if(e.getStateChange()==ItemEvent.SELECTED){
                    ...
                    resizeWindowAndComponents(parentFrame, Integer.parseInt(selectedIN.split("x")[0]),
        ...
        themeComboBox.addItemListener(new ItemListener(){
            public void itemStateChanged(ItemEvent e){
                ...
                if(e.getStateChange()==ItemEvent.SELECTED){
                    ...
                    ThemeWindow("Reset",parentFrame);


                    //resetTheme((JFrame) SwingUtilities.getWindowAncestor(themeLabel));
                    ThemeWindow(selectedTheme, parentFrame);
        ...
        FixedCheckBox.addItemListener(new ItemListener(){
            public void itemStateChanged(ItemEvent e){
                ...
                if(e.getStateChange()==ItemEvent.SELECTED){
                    ...
                    FixedWindow(1, parentFrame);
                }
                else {
                    FixedWindow(0, parentFrame);
                }
            }});
